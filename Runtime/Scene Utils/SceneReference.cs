...
namespace Evbishop.Runtime.SceneUtils
{
    ...
    public class SceneReference : ISerializationCallbackReceiver
    {
        ...
        private string GetSceneNameFromAsset()
        {
            if (sceneAsset == null)
                return string.Empty;
            return Path.GetFileNameWithoutExtension(GetScenePathFromAsset());
        }

        private int GetBuildIndexFromAsset()
        {
            if (sceneAsset == null)
                return -1;
            return SceneUtility.GetBuildIndexByScenePath(GetScenePathFromAsset());
        }
    ...
    public class SceneReferencePropertyDrawer : PropertyDrawer
    {
        ...
        // The exact name of  the scene Name variable in the SceneReference object
        const string sceneNamePropertyString = "sceneName";
        // The exact name of  the build Index variable in the SceneReference object
        const string buildIndexPropertyString = "buildIndex";
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                // If no valid scene asset was selected, reset the stored property values accordingly
                if (buildScene.scene == null)
                {
                    ...
                    GetBuildIndexProperty(property).intValue = -1;
                }
            }
        ...
        static SerializedProperty GetBuildIndexProperty(SerializedProperty property)
        {
            return property.FindPropertyRelative(buildIndexPropertyString);
        }
